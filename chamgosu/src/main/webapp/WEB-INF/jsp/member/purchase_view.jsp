    ...
    <table class="bbs_write01">
      ...
      <tbody>
        <tr>
          <th scope="row">* 아이디<br>
            (사업자등록번호)</th>
          <td colspan="3"><input type="text" class="inputTxt" name="chkid" id="chkid" style="width:20%;" />
            <input value="중복체크" type="button" name="chkID_btn" id="chkID_btn" class="btns01" /></td>
        </tr>
        <tr>
          <th scope="row" class="bleft">* 대표자명</th>
          <td colspan="3"><input type="text" name="name01" id="name01" class="inputTxt" style="width:100px;" /> <input value="본인인증" type="button" class="btns01" /></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td colspan="3"><input type="number" style="ime-mode:disabled; width:100px;" onkeypress="return digit_check(event)" class="inputTxt" /> 원</td>
        </tr>
        <tr>
