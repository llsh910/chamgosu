    ...
    <table class="bbs_write01">
      ...
      <tbody>
        <tr>
          <th scope="row">* 아이디<br>
            (사업자등록번호)</th>
          <td><input type="text" class="inputTxt" name="chkid" id="chkid" style="width:40%;" />
            <input value="중복체크" type="button" name="chkID_btn" id="chkID_btn" class="btns01" /></td>
          <th scope="row" class="bleft">승인여부</th>
          <td><input type="radio" class="rdo" name="rdo" />
            승인완료
        ...
        <tr>
          <th scope="row">* 단체명</th>
          <td><input type="text" name="name" id="name" class="inputTxt" style="width:60%;" /></td>
          <th scope="row" class="bleft">* 대표자명</th>
          <td><input type="text" name="name01" id="name01" class="inputTxt" style="width:100px;" />
            <input value="본인인증" type="button" class="btns01" /></td>
        </tr>
        <tr>
          <th scope="row">* 현재 비밀번호</th>
          <td colspan="3"><input type="password" name="pass" id="pass" class="inputTxt" style="width:150px;" />
        ...
        <tr>
          <th scope="row">* 주소</th>
          <td colspan="3"><input type="text" id="post1" name="post1" class="inputTxt" style="width:100px;" title="우편번호 입력" />
            <input value="우편번호찾기" type="button" class="btns" />
            <input type="text" id="addrDetail" name="addrDetail" class="inputTxt" style="width:400px;" /></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td colspan="3"><textarea rows="3" class="inputTxt" style="width:80%;"></textarea>
            200자 내외</td>
        </tr>
        <tr>
          <th scope="row">* 지급계좌정보<br>
            (본인실명인증계좌)</th>
          <td colspan="3">은행
            <input type="text" class="inputTxt mgr15" style="width:70px;" />
            계좌
            <input type="number" style="ime-mode:disabled; width:200px;" onkeypress="return digit_check(event)" class="inputTxt mgr15" />
            예금주
        ...
        <tr>
          <th scope="row">* 주민등록번호<br>
            또는 사업자등록번호</th>
          <td colspan="3"><input type="text" class="inputTxt mgr15" style="width:200px;" /></td>
        </tr>
        <tr>
          <th scope="row">총 수수료</th>
          <td><input type="number" style="ime-mode:disabled; width:100px;" onkeypress="return digit_check(event)" class="inputTxt" />
            원</td>
        ...
        <tr>
          ...
          <td colspan="3"><input type="text" class="file_input_textbox" id="fileName" style="width:300px" value="학원,교습소,공부방,교육단체 입증가능 서류" readonly >
            ...
            <input type="text" class="file_input02_textbox" id="fileName02" style="width:300px" value="단체로고" readonly >
        ...
        <tr>
          ...
          <td class="agr"><input type="radio" class="rdo" name="rdo" />
            예
