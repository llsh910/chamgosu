...
<div id="header">
  <ul>
    <li class="fl"><img src="../img/layout_logo.png" alt="참고수"></li>
    <li class="fr pdt20"><span><b>접속자</b> : 참고수</span><span><b>접속권한</b> : 상품관리</span><a href="#"><img src="../img/logout.png" alt="로그아웃"> 로그아웃</a></li>
  </ul>
</div>
<!--/header-->
